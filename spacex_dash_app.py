...
#####BS - Options to display unique value of LaunchSite to the dropdown
optionsD = spacex_df['Launch Site'].unique().tolist()
optionsD.insert(0, 'ALL')
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',
                                                ...
                                                #    {'label': 'All Sites', 'value': 'ALL'},
                                                    {'label': i, 'value': i} for i in optionsD
                                                ],
                                                value='ALL',
...
def get_pie_chart(entered_site):
    title_pie = f"Success Launches for {entered_site}"  
    if entered_site == 'ALL':
